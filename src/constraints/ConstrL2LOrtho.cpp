...
double georis::ConstrL2LOrtho::error()const{
	...
	if ( a1x*a1x + a1y*a1y < epsi*epsi ) throw std::runtime_error("ConstrL2LOrtho - not a line 1!");
	if ( a2x*a2x + a2y*a2y < epsi*epsi ) throw std::runtime_error("ConstrL2LOrtho - not a line 2!");
